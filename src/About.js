        ...
        <div className="withmaxwidth">
          ...
          <div className="aboutpagetext">
            ...
            <p>
              ...
              אודות הפיזיולוגיה, האנטומיה והאתולוגיה של מגוון בעלי חיים, ובשנים
              האחרונות הקדשתי חלק לא מבוטל מזמני בלימוד התנהגותם של חתולים, הבנת
              צרכיהם וחיפוש אחר דרכים לשפר את רווחתם בבית.
              <br />
              <br />
              בסיום לימודיי, הוכשרתי כמאבחנת, יועצת ומטפלת התנהגותית לחתולים
              בשיטה החיובית ("Force free") בהתמחות תחת הנחייתה של אפרת סימון.
              <br />
              <br />
              בעבודתי כיועצת התנהגות אני מסייעת לבעלי חתולים להתמודד עם מגוון
              בעיות, מספקת להם כלים לתקשורת נכונה עם חתולים, מייעצת ומנחה לגידול
              נכון של חתולי בית תוך דגש על צרכיו הטבעיים של החתול והדרכים
              למימושם בסביבה הביתית.
              <br />
              <br />
              אני מאמינה שעם ליווי מקצועי, סבלנות והרבה אהבה, יכול כל אדם להגיע
              לחיים שקטים והרמוניים עם חתוליו ולהנות משפע היתרונות של מחייה
              בסביבת בעלי חיים.
            </p>
          </div>
        </div>
        ...
        <div className="withmaxwidthnoflex">
          ...
          <div className="whatcanidoText">
            <p>
              ...
              <br /> <br />
              ניתן לפנות אליי לפתרון מגוון בעיות התנהגותיות שיש לכם עם חתולכם,
